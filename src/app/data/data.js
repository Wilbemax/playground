...
export const menuItems = [
	...
	},
	{
		id: 'popular',
		linkText: 'Популярные',
		linkHref: '/pages/popular',
	},
	{
		id: 'shooters',
		linkText: 'Шутеры',
		linkHref: '/pages/shooter',
	},
	{
		id: 'runners',
		linkText: 'Ранеры',
		linkHref: '/pages/runner',
	},
	{
		id: 'pixel',
		linkText: 'Пиксельные',
		linkHref: '/pages/pixel',
	},
	{
		id: 'tds',
		linkText: 'TDS',
...
//   const gameId =  1; // ID игры, которую мы хотим найти
//   const foundGame = getGamesById(gameId);
